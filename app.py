...
# ==========================================
# 完整字典：包含熱門主流題材（已加入主動元件與電源控制）與傳統細產業
# ==========================================
my_custom_sectors = {
    # --- 🔥 熱門主流題材（已加入主動元件與電源控制）---
    '主動元件與功率半導體': ['2481', '5425', '8255', '2342', '4943', '6525', '3707', '2303', '2330'],
    '電源管理與控制IC': ['6415', '4961', '3588', '6282', '8155', '2362', '3015', '6796', '5386', '4952'],
    ...
    '記憶體DRAM概念股': ['2408', '2344', '3260', '8299', '2337', '8271', '6488', '3532', '2342', '3006', '8088', '2451'],
    '被動元件概念股': ['2327', '2456', '3026', '6173', '2498', '5328', '2472', '3624', '8043', '3090', '2492', '3026'],
    '低軌衛星概念股': ['2314', '3491', '3450', '6285', '2345', '3704', '5388', '6278', '2313', '2634', '2383', '4916', '2485', '6190', '6443', '3105', '6271', '3305', '2355'],
    '蘋概股精選': ['2330', '3008', '4938', '2474', '2313', '4958', '3406', '6269'],
    '重電與綠能概念股': ['1503', '1519', '1513', '1514', '1504', '9958', '3708', '6806', '6505'],
    'ABF概念股': ['8046', '4958', '3037', '3189'],
    '無人機概念股': ['2634', '8033', '8383', '5371', '6209', '3019', '6202', '8038'],
    '軍工概念股': ['1810', '2634', '6829', '2645', '8033', '6753', '8383', '2208', '4916', '8222', '3491', '4541', '3005', '5222', '2419', '3004'],
    'FOPLP概念股': ['3481', '3711', '6239', '6187', '3455', '8064', '8027', '3580', '3663', '3131', '3535', '6664', '3563'],
    ...
    '安全監控': ['3454', '3356', '8072', '3128', '2398', '2332', '6419', '2390', '5484', '3669', '9917', '3434', '5251', '5489', '6556', '3297', '6560', '6708'],
...
sector_categories = {
    "🔥 熱門主流題材": ['主動元件與功率半導體', '電源管理與控制IC', 'CPO矽光子概念股', 'AI伺服器概念股', 'FOPLP概念股', 'CoWoS先進封裝概念股', '記憶體DRAM概念股', '被動元件概念股', '低軌衛星概念股', '蘋概股精選', '重電與綠能概念股', 'ABF概念股', '無人機概念股', '軍工概念股'],
